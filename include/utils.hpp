...
std::vector<unsigned char>::iterator findHeader(std::vector<unsigned char> &vec);
std::vector<unsigned char>::iterator findNewLine(std::vector<unsigned char> &vec);
std::vector<unsigned char>::iterator findNewLineNewLine(std::vector<unsigned char> &vec);
