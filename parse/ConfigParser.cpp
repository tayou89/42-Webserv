...
ConfigParser::ConfigParser(const ConfigParser &object)
{
    *this = object;
}
...
ConfigParser::ConfigParser(const std::string &configText, const std::set<std::string> directiveSet)
...
const std::string &ConfigParser::getBlock(void) const
{
    return (_block);
}
