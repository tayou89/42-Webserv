...
bool ConfigFile::isAccessible(void) const
{
    return (_status.isAccessible);
}

bool ConfigFile::isReadable(void) const
{
    return (_status.isReadable);
}

bool ConfigFile::isWritable(void) const
{
    return (_status.isWritable);
}

bool ConfigFile::isExecutable(void) const
{
    return (_status.isExecutable);
}

void ConfigFile::set(const std::string &dirPath, const string_vector &fileList)
{
    _directory = dirPath;
    _path.clear();
