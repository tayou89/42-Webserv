...
void Location::_setRootDirectory(void)
{
    _rootDirectory = _parameters[0];
}
...
void Location::_setClientBodyMax(void)
{
    ...
    std::size_t unit       = ConfigUtil::convertByteUnit(sizeString[sizeString.size() - 1]);
