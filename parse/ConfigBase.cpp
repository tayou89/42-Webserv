...
ConfigBase::ConfigBase(const ConfigBase &object)
{
	*this = object;
}
...
ConfigBase::ConfigBase(const std::string &configText, const string_set &directiveSet)
	: _configParser(configText, directiveSet)
{
}

ConfigBase::ConfigBase(const char *configFilePath, const string_set &directiveSet)
	: _configFile(configFilePath), _configParser(_configFile.getFileString(), directiveSet)
{
}
