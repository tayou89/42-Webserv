...
// {
// 	std::size_t	stringCount = vector.size();
// 	std::size_t	i;
...
// 	std::cout << "======================Location
// Config==========================\n"; 	if (locations.size() == 0)
// std::cout << "Can't print location: this server config doen't have any
// location\n"; 	else
// 	{
...
// '\n'; 	if (location.getAutoIndex()) 		std::cout << "Autoindex:
// true\n"; 	else 		std::cout << "Autoindex: false\n"; 	std::cout << "Return: "
// << location.getReturn() << '\n';
...
// {
// 	std::vector<std::string>::const_iterator	iterator =
// httpMethods.begin(); 	std::vector<std::string>::const_iterator
// endPoint = httpMethods.end();
