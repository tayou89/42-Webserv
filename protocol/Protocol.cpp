...
Protocol::Protocol(const Protocol &ref)
    : _requestHeader(ref._requestHeader), _requestBody(ref._requestBody),
      _requestMethod(ref._requestMethod), _requestURI(ref._requestURI),
      _responseHeader(ref._responseHeader), _responseBody(ref._responseBody),
...
std::string Protocol::readStartLine(std::string startLine,
